...
★★ **JVM ごと落ちた場合には届かない。** 電源断・強制終了と、**Windows のログオフ・シャットダウン**（#141）がそれに当たり、**控えは残るが誰も何も言わない。** ★ **この道具から終わらせる経路は塞いである**——**書き出しが走っている間は、メニューの「終了」も窓の × も、その場では閉じない**（#134）。断るのではなく**覚えて待ち、書き終わってから閉じる**。**待たせる上限は置かない**——置いて切ると、**切った先がまさにこの状態である。** 待っている間は状態行に理由が出る（`CLAUDE.md` 優先順位 2）。 起動時に走査して拾う形は採らない——**出力先は利用者が選ぶ任意のフォルダであり、どこを走査してよいのか決まらない**（§10.1）。判断の経緯は `docs/HANDOVER.md`「決まったことの記録」にある。
